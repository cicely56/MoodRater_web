...
function pageExplain(){
  ...
  section_1.classList.add("section1");
  section_1.id="sec1";
  $("section1").append(section_1);
  ...
  $("section1").append(task);
  $("section1").append(paragraph);
  $("section1").append(exp_section1);
  ...
  paragraph.innerHTML = "Please confirms your ratings, and provide the reasons behind your choices. You will be asked to do this for the ratings in 6 short sections"+'<br>'+"We would like to know what music features led to some emotion ratings you have just made. "+ "<br>" +
	"&nbsp; 1. Please listen to the shortsection again and review your emotion ratings. This can be done by hovering on the timeline graph below the player, your previous emotion ratings will show up on the VA space on the right. " 
	+ "<br>" +
 	" 		 2. Click on each rating point to raise a pop-up window where you can confirm that rating by provide the confidence level in the form, or digard the rating by select <strong>I want to disgard the rating</strong>."
 	+"<br>" +
 	"  		3. Once a rating is confirmed, we would like you to write down the reasons behind the rating. ."
 	+"<br>" +"<br>" +
 	"<pre>Examples of possible reasons might be</pre>"
 	+"<br>" +
...
+ "<br>" +
 	" 	4 Once a rating is disgard, please leave the reason area blank and move on to the next rating."
  //timeLogIn.Arousal;

exp_section1.innerHTML = "Short Section 1/6"
exp_section2.innerHTML = "<br>"+"Short Section 2/6"
...
var vachart1 = document.createElement('div');
	...
	lineplotandcmes("mylinechart1",0,51,"mycanvasE1","emotionlabel1",commentLogIn2,);
  ...
  var vachart2 = document.createElement('div');
    ...
    // lineplotandcmes("mylinechart2",5,25,"mycanvasE2","emotionlabel2",commentLogIn2);
